...
public class SA_SAS_main {
	...
	protected SolutionSet findParetoFront(double[] weights, double[][] fixed_bounds, int vars,  int numberOfObjectives_, int numberOfConstraints_) throws JMException,
		...
		algorithm = new SA_SAS(problem, weights, fixed_bounds);
